...
**Правило:** при добавлении новых важных пользовательских сценариев добавляйте соответствующие E2E в `apps/web/e2e/`. Уже покрыты: бронирование (в т.ч. с гостем), QuickDesk (смена статусов), смены и финансы сотрудника, промо, споры по финансам, перерасчёт часов. См. также чеклист в [CONTRIBUTING.md](../../../CONTRIBUTING.md).
