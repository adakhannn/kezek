                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
                    <div className="flex items-start sm:items-center gap-2 flex-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm font-medium leading-relaxed">
                            {t('notifications.telegram.message', 'Подключите Telegram для получения уведомлений о бронированиях. Это удобно и безопасно!')}
                        </p>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                        ...
                        >
                            <span className="hidden sm:inline">{t('notifications.telegram.connectFull', 'Подключить Telegram')}</span>
                            <span className="sm:hidden">{t('notifications.telegram.connectShort', 'Подключить')}</span>
                        </button>
                        <button
