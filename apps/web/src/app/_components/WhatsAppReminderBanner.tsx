...
export function WhatsAppReminderBanner() {
    ...
    return (
        <>
            <div className="sticky top-14 sm:top-16 z-[35] bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
                        <div className="flex items-start sm:items-center gap-2 flex-1 min-w-0">
                            ...
                            <p className="text-xs sm:text-sm font-medium leading-relaxed">
                                {t('notifications.whatsapp.message', 'Подключите WhatsApp для получения уведомлений о бронированиях. Это удобнее и быстрее!')}
                            </p>
                        </div>
                        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                            ...
                            >
                                <span className="hidden sm:inline">{t('notifications.whatsapp.connectFull', 'Подключить WhatsApp')}</span>
                                <span className="sm:hidden">{t('notifications.whatsapp.connectShort', 'Подключить')}</span>
                            </button>
                            <button
