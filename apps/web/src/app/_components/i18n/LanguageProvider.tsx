...
const dictionaries: Dictionaries = {
    ky: {
        ...
        'staff.transfer.title': 'Кызматкерди которуу',
        'staff.transfer.current': 'Учурдагы филиал:',
        'staff.transfer.target.label': 'Жаңы филиал *',
        'staff.transfer.target.select': '— танда —',
        'staff.transfer.copySchedule': 'Эски филиалдан графиктин үлгүсүн көчүрүү',
        'staff.transfer.cancel': 'Жокко чыгаруу',
        'staff.transfer.submit': 'Которуу',
    ...
    en: {
        ...
        'staff.transfer.title': 'Transfer staff',
        'staff.transfer.current': 'Current branch:',
        'staff.transfer.target.label': 'New branch *',
        'staff.transfer.target.select': '— select —',
        'staff.transfer.copySchedule': 'Copy schedule template from old branch',
        'staff.transfer.cancel': 'Cancel',
        'staff.transfer.submit': 'Transfer',
