            ...
            <div className="w-full max-w-md">
                <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-800 space-y-6">
                    ...
                    <button
                        ...
                        disabled={sending}
                        className="w-full px-6 py-3.5 bg-[#25D366] dark:bg-[#25D366] text-white font-semibold rounded-lg hover:bg-[#20BA5A] dark:hover:bg-[#20BA5A] shadow-sm hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                    >
