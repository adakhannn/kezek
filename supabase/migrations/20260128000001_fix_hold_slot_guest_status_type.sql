-- Исправление ошибки типа booking_status в функции hold_slot_guest
-- Проблема: переменная v_status не всегда правильно распознается PostgreSQL как тип booking_status
-- Решение: использовать литерал 'hold'::booking_status напрямую в INSERT
